...
const translations = {
  ...
  zh: {
    ...
    alphabetical: '字母顺序',
    viewAsGrid: '以网格形式查看',
    viewAsListText: '以列表形式查看',
    noProjectsFound: '未找到项目',
    viewProjectDetails: '查看详情',
    githubRepository: 'GitHub',
    liveDemo: '实时演示',
    searchBlog: '搜索博客文章',
    filterByTag: '按标签筛选',
    ...
    comments: '评论',
    shareArticle: '分享文章',
    letsBuildFuture: '让我们创造未来',
    connectWithDeveloper: '与打造智能系统的远见卓识的开发者联系',
    sendMessage: '发送消息',
    callNow: '立即致电',
    digitalPathways: '数字连接途径',
    aiSolutionDescription: '无论您是在设想AI解决方案、IoT系统还是网络应用',
    digitalCourier: '数字信使',
    voiceChannel: '语音渠道',
    geolocation: '地理位置',
    responseProtocol: '响应协议',
    withinHours: '24小时内',
    connectThroughNetworks: '通过数字网络连接',
    fullName: '全名',
    yourEmail: '您的电子邮件',
    subject: '主题',
    yourMessage: '您的消息',
