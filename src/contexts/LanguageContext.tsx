...
const translations = {
  en: {
    ...
    viewAsListText: 'View as list',
    noProjectsFound: 'No projects found',
    viewProjectDetails: 'View Details',
  ...
  sw: {
    ...
    viewAsGrid: 'Angalia kama gridi',
    viewAsListText: 'Angalia kama orodha',
    noProjectsFound: 'Hakuna miradi iliyopatikana',
    viewProjectDetails: 'Angalia Maelezo',
    githubRepository: 'GitHub',
    liveDemo: 'Demo Moja kwa moja',
    searchBlog: 'Tafuta machapisho ya blogu',
    filterByTag: 'Chuja kwa lebo',
    noBlogsFound: 'Hakuna machapisho ya blogu yaliyopatikana',
    readingTime: 'dakika za kusoma',
    publishedBy: 'Na',
    likes: 'Kupenda',
    comments: 'Maoni',
    shareArticle: 'Shiriki Makala',
    letsBuildFuture: 'Wacha Tujengu Mustakabali',
    connectWithDeveloper: 'Unganisha na mjumbe mtengenezaji wa akili anayofanya mifumo ya akili',
    sendMessage: 'Tuma Ujumbe',
    callNow: 'Piga simu sasa',
    digitalPathways: 'Njia za Kidijitali za Kuunganisha',
    aiSolutionDescription: 'Ikiwa una mtu anayechua suluhisho la AI, mfumo wa IoT, au programu ya wavuti',
    digitalCourier: 'Mjumbe wa Kidijitali',
    voiceChannel: 'Njia ya Sauti',
    geolocation: 'Mahali geographia',
    responseProtocol: 'Itifaki ya Mwitikio',
    withinHours: 'Ndani ya saa 24',
    connectThroughNetworks: 'Unganisha Kupitia Mitandao ya Kidijitali',
    ...
    submit: 'Tuma',
    submitting: 'Inatuma...',
    messageSent: 'Ujumbe umotumwa haraka!',
    errorSending: 'Hitilafu katika kutuma ujumbe',
    loading: 'Inapakia...',
    error: 'Hitilafu',
    success: 'Mafanikio',
    cancel: 'Ghairi',
    ...
    tryAnotherSearch: 'Jaribu tafuta nyingine',
  ...
  fr: {
    ...
    viewAsGrid: 'Voir comme grille',
    viewAsListText: 'Voir comme liste',
    noProjectsFound: 'Aucun projet trouvé',
    viewProjectDetails: 'Voir les détails',
    githubRepository: 'GitHub',
    liveDemo: 'Démo en direct',
    searchBlog: 'Rechercher des articles de blog',
    ...
    letsBuildFuture: 'Construisons l\'avenir',
    connectWithDeveloper: 'Connectez-vous avec un développeur visionnaire créant des systèmes intelligents',
    sendMessage: 'Envoyer un message',
    callNow: 'Appelez maintenant',
    digitalPathways: 'Chemins numériques pour se connecter',
    aiSolutionDescription: 'Que vous imaginiez une solution d\'IA, un système IoT ou une application web',
    digitalCourier: 'Courrier numérique',
    voiceChannel: 'Canal vocal',
    geolocation: 'Géolocalisation',
    responseProtocol: 'Protocole de réponse',
    withinHours: 'Dans les 24 heures',
    connectThroughNetworks: 'Connectez-vous via des réseaux numériques',
  ...
  hi: {
    ...
    searchProjects: 'परियोजनाओं को खोजें',
    ...
    viewAsGrid: 'ग्रिड के रूप में देखें',
    viewAsListText: 'सूची के रूप में देखें',
    noProjectsFound: 'कोई परियोजना नहीं मिली',
    viewProjectDetails: 'विवरण देखें',
    githubRepository: 'GitHub',
    liveDemo: 'लाइव डेमो',
    searchBlog: 'ब्लॉग पोस्ट खोजें',
    filterByTag: 'टैग द्वारा फ़िल्टर करें',
    noBlogsFound: 'कोई ब्लॉग पोस्ट नहीं मिली',
    readingTime: 'मिनट पढ़ें',
    publishedBy: 'द्वारा',
    likes: 'पसंद',
    comments: 'टिप्पणियां',
    shareArticle: 'लेख साझा करें',
    letsBuildFuture: 'आइए भविष्य बनाएं',
    connectWithDeveloper: 'एक दूरदर्शी डेवलपर से जुड़ें जो बुद्धिमान प्रणाली बना रहा है',
    sendMessage: 'संदेश भेजें',
    callNow: 'अभी कॉल करें',
    digitalPathways: 'कनेक्ट करने के लिए डिजिटल पथ',
    aiSolutionDescription: 'चाहे आप एक AI समाधान, IoT सिस्टम या वेब एप्लिकेशन की कल्पना कर रहे हों',
    digitalCourier: 'डिजिटल कूरियर',
    voiceChannel: 'वॉयस चैनल',
    geolocation: 'भूगोल',
    responseProtocol: 'प्रतिक्रिया प्रोटोकॉल',
    withinHours: '24 घंटे के भीतर',
    connectThroughNetworks: 'डिजिटल नेटवर्क के माध्यम से कनेक्ट करें',
    fullName: 'पूरा नाम',
    yourEmail: 'आपका ईमेल',
    subject: 'विषय',
    ...
    errorSending: 'संदेश भेजने में त्रुटि',
    ...
    tryAnotherSearch: 'दूसरी खोज का प्रयास करें',
