...
const Blog = () => {
  ...
  const structuredData = {
    ...
    "@type": "Blog",
    "name": "John Doe's Development Blog",
    "description": "Insights, tutorials, and thoughts on web development, technology trends, and best practices",
    ...
    "blogPost": blogPosts.map(post => ({
      ...
      "url": `https://yourportfolio.com/blog/${post.id}`,
  ...
  return (
    <>
      <SEO 
        title="Blog & Articles - John Doe | Web Development Insights & Tutorials"
        description="Sharing insights, tutorials, and thoughts on web development, technology trends, and best practices. Learn React, TypeScript, Node.js and modern development techniques."
        keywords="web development blog, React tutorials, TypeScript guides, Node.js articles, JavaScript tips, development best practices, coding tutorials"
        url="https://yourportfolio.com/blog"
